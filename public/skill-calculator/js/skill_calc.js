...
function syncRemainingPointsDisplay() {
    var el = document.getElementById("remainingpoints");
    if(el) {
        el.innerHTML = String(current);
    }
}
...
// builds all class trees based on definitions for base_class and master_class
{
    ...
    buildTree(master_class2, "mc-tree2");
    addTreeEvents(master_class2);
}
...
function showinfo(skill)
{
    ...
    info_height = box.offsetHeight;
    info_width = box.offsetWidth;
}
        ...
        if(add == 1)
        {
            ...
            if((check2 == "glow" || (currentpoints > 0) || (initv == 1)) && maxlevelcheck(skill,currentpoints+1))
            {
                if(currentpoints < maxpoints && current < (max - 1))
                {
                    ...
                    {
                        current++;
                        document.getElementById("SP_REMAINING").innerHTML = parseInt(document.getElementById("SP_REMAINING").innerHTML) + 1;
                        ...
                        else if(skill_class.toUpperCase() == master_class.toUpperCase()) { document.getElementById("masterclasspoints").innerHTML = parseInt(document.getElementById("masterclasspoints").innerHTML) + 1; }
                        else { document.getElementById("masterclasspoints2").innerHTML = parseInt(document.getElementById("masterclasspoints2").innerHTML) + 1; }
                        if(disablesave==0) updateurl(skill, 1);
                        syncRemainingPointsDisplay();
                    }
...
function changeurls()
{
    ...
    if(refresh_url == 1 && window.history.replaceState) {
        var nextSearch = historyoutput ? ("?" + historyoutput) : "";
        window.history.replaceState({ state: "skill-calc" }, document.title, site_url + nextSearch);
    }
    ...
    if(is_local) {
        ...
        document.getElementById("calcurl").href = site_url + "?" + historyoutput;
        document.getElementById("calcurl2").href = site_url + "?" + historyoutput;
    } else {
...
function initurl()
{
    site_url = window.location.pathname.split('?')[0] || "";
    frame_url = site_url;
    ...
    else
    {
        ...
        var mc2 = master_class2.toLocaleLowerCase();
        st[mc2].forEach(function(value) {
            if(pos == -1) {
                pos = 0;
            } else {
                if(!isNaN(Number(value)) && value != -1) {
                    if(sd[value][URL_POS] != -1 && !(value in complete)) {
                        ...
                        if(importlevel != 0) {
                            ...
                            if(sd[value][SKILL_REQ_1] != -1 && !(sd[value][SKILL_REQ_1] in complete)) {
                                initBacktrack(sd[value][SKILL_REQ_1], mc2);
                            }

                            if(sd[value][SKILL_REQ_3] != -1 && !(sd[value][SKILL_REQ_3] in complete)) {
                                initBacktrack(sd[value][SKILL_REQ_3], mc2);
                            }

                            for(l = 0; l < importlevel; l++) {
                                skillclick(value, pos, 1, mc2);
                            }
                            disabletool = 0;
                        }
                        complete[value] = 1;
...
{
    switch(master_class){
        case 11: master_class = "HSF"; master_class2 = "HSM";
        case "HSF": class_name = "Fighter"; class_name2 = "Swordsman"; base_class = "HFI"; break;
        case 17: master_class ="HSM"; master_class2 = "HSF";
        case "HSM": class_name = "Swordsman"; class_name2 = "Fighter"; base_class = "HFI"; break;
        
        case 12: master_class = "HCR"; master_class2 = "HTR";
        case "HCR": class_name = "Crane-Hermit"; class_name2 = "Turtle-Hermit"; base_class = "HMY"; break;
        case 18: master_class = "HTR"; master_class2 = "HCR";
        case "HTR": class_name = "Turtle-Hermit"; class_name2 = "Crane-Hermit"; base_class = "HMY"; break;
        
        case 13: master_class = "NDW"; master_class2 = "NSK";
        case "NDW": class_name = "Dark-Warrior"; class_name2 = "Shadow-Knight"; base_class = "NFI"; break;
        case 19: master_class = "NSK"; master_class2 = "NDW";
        case "NSK": class_name = "Shadow-Knight"; class_name2 = "Dark-Warrior"; base_class = "NFI"; break;

        case 14: master_class = "NDH"; master_class2 = "NPS";
        case "NDH": class_name = "Dende-Priest"; class_name2 = "Poko-Priest"; base_class = "NMY"; break;
        case 20: master_class = "NPS"; master_class2 = "NDH";
        case "NPS": class_name = "Poko-Priest"; class_name2 = "Dende-Priest"; base_class = "NMY"; break;
        
        case 15: master_class = "MUL"; master_class2 = "MGR";
        case "MUL": class_name = "Ultimate-Majin"; class_name2 = "Grand-Chef-Majin"; base_class = "MMI"; break;
        case 21: master_class = "MGR"; master_class2 = "MUL";
        case "MGR": class_name = "Grand-Chef-Majin"; class_name2 = "Ultimate-Majin"; base_class = "MMI"; break;
        
        case 16: master_class = "MPL"; master_class2 = "MKR";
        case "MPL": class_name = "Plasma-Majin"; class_name2 = "Karma-Majin"; base_class = "MWO"; break;
        case 22: master_class = "MKR"; master_class2 = "MPL";
        case "MKR": class_name = "Karma-Majin"; class_name2 = "Plasma-Majin"; base_class = "MWO"; break;
    }
